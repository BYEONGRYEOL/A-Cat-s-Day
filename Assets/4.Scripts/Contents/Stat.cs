...
namespace Isometric
{
    ...
    public class Stat : MonoBehaviour
    {
        ...
        public Enums.State GetAttacked(Stat attacker, Enums.AttackType attackType = Enums.AttackType.AD)
        {
            float damage = 0;
            switch (attackType)
            {
        ...
        private void Init()
        {
            ...
            foreach(KeyValuePair<int, Data.EnemyStat> enemyStat in Managers.Data.EnemyStatDict)
            {
            ...
            Data.EnemyStat stat = Managers.Data.EnemyStatDict[enemy_id];
